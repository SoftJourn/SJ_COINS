...
public class DonationsService {
  ...
  public Transaction donateToProject(
      @NonNull String accountName, @NonNull String projectId,
  ...
  @SuppressWarnings("unused")
  @SaveTransaction(comment = "Move money from project to treasury.", type = TRANSFER)
  public synchronized Transaction refundProject(
      String projectId, List<BatchTransferDTO> transfers
  ) {
    BigDecimal amount = getAmount(projectId);
