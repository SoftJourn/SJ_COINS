...
public interface FabricService {
    ...
    <T> T invoke(String email, Chaincode chaincode, String function, Object args, Class<T> responseType);

    <T> T query(String email, Chaincode chaincode, String function, Object args, Class<T> responseType);
}
